...
const config = require("../../../JSON/Hey_Config.json");
...
module.exports = (client) => {
    ...
    client.on("guildMemberAdd", async (member) => {
        ...
        const value = [
            ...
            `<:p_dot:837257989563744256> Make sure to read our rules first , here <#838363448986566667>.`,
            `<:p_dot:837257989563744256> Get some roles yourself from , here <#838363477517139978>.`
        ];

      
        const embed = new Discord.MessageEmbed()
            .setAuthor(`${member.displayName} Just Join Our Server ${guild.name}`, member.user.displayAvatarURL({ dynamic: true }),"https://discord.gg/X8TMRvaBYw")
