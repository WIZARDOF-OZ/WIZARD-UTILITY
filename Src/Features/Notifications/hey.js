...
module.exports = (client) => {
    ...
    client.on("guildMemberAdd", async (member) => {
        ...
        const value = [
            ...
            `<:p_dot:837257989563744256> Make sure to read our rules first , here <#827595833469698068>.`,
            `<:p_dot:837257989563744256> Get some roles yourself from , here <#831445149787095060>.`
        ];
